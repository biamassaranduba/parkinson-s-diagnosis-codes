...
for i = 1:25
    ...
    filepath = strcat('C:\Users\biama\Desktop\UNIVASF\Mestrado\Selecao_das_bases\oddball\',auxstr); 
        ...
        sinal(1,:) = (EEGext.data(1,:)) - (EEGext.data(32,:));
        sinal(2,:) = (EEGext.data(33,:)) - (EEGext.data(63,:));
        sinal3= (EEGext.data(34,:)) - (EEGext.data(62,:));
        sinal1 = (EEGext.data(canal,:)) - (EEGext.data(canal,:));
        sinal1 = (EEGext.data(canal,:)) - (EEGext.data(canal,:));
        sinal1 = (EEGext.data(canal,:)) - (EEGext.data(canal,:));
        sinal1 = (EEGext.data(canal,:)) - (EEGext.data(canal,:));
        sinal1 = (EEGext.data(canal,:)) - (EEGext.data(canal,:));
