...
load('bootssubctrlongama.mat');
Inputs = subctrlongama(:,1:end-1);
Labels = [ones(24,1); zeros(24,1)]; 
...
CTRL_Inputs = Inputs(1:n,:); OFF_Inputs = Inputs(n:end,:);
CTRL_Labels = Labels(1:n,:); OFF_Labels = Labels(n:end,:); n2 = length(OFF_Inputs(:,1));
